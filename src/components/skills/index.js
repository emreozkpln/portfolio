...
export default function Skills() {
    ...
    return (
        <div id="skills" className="bg-[#1C1C27] pt-16 px-4 sm:px-0">
            <div className='w-full container mx-auto max-w-6xl'>
                <motion.div variants={container} initial='hidden' animate='visible' className="flex flex-col items-center justify-center gap-6">
                    ...
                    <motion.div variants={item} className="text-[#b1b2b3] text-center max-w-[600px] text-lg">{Bio.descriptionSkills}</motion.div>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-32 mb-10">
                        {SkillSet.map((item, index) => (
                            <div className="bg-[#171721] border border-solid border-[#7846CF] rounded-xl mt-5" key={index}>
                                <div className="flex flex-col p-4 px-10 gap-y-6 text-white items-center">
